...
MENU_TEMPLATE_ITEM MainMenuTemplate[] =
    {
        ...
        {MNTT_SP, -1, MNTS_B | MNTS_I | MNTS_A, 0, -1, 0, NULL},
        // feature 028: visual theme switch (Default / Dark)
        {MNTT_PB, IDS_MENU_OPT_THEME, MNTS_B | MNTS_I | MNTS_A, CML_OPTIONS_THEME, -1, 0, NULL},
        {MNTT_IT, IDS_MENU_OPT_THEME_DEFAULT, MNTS_B | MNTS_I | MNTS_A, CM_THEME_DEFAULT, -1, 0, NULL},
        {MNTT_IT, IDS_MENU_OPT_THEME_DARK, MNTS_B | MNTS_I | MNTS_A, CM_THEME_DARK, -1, 0, NULL},
        {MNTT_PE},
